...
int main(){
    ...
    for(int i=0;i<num;i++){
        cout<<"Enter the prio of the process\n";
        cin>>checkPrio;
    ...
    for(int i =0;i<3;i++){
        for(int j=0;j<num;j++){
            if((q[i].prio_st<=p1[j].prio) && (p1[j].prio<=q[i].prio_end)){
                if(i==0){
                    q[i].p[a++] = p1[j];
        ...
        if(l==0){
            ...
            for(int i=0;i<q[l].len;i++){
                ...
                while(rr_timer>0 && q[l].p[i].bTime!=0 && timer!=10){
                    cout<<"Executing queue 1 and "<<i+1<<" process for a unit time. Process has prio of "<<q[l].p[i].prio<<"\n";
                    q[l].p[i].bTime--;
                    timing(q);
                    rr_timer--;
                    timer++;
            ...
            for(int i=0;i<q[l].len;i++){
                ...
                while(q[l].p[i].bTime!=0 && timer!=10){
                    cout<<"Executing queue 2 and "<<i+1<<" process for a unit time. Process has prio of "<<q[l].p[i].prio<<"\n";
                    q[l].p[i].bTime--;
                    timing(q);
                    timer++;
                    cout<<l<<"\t"<<timer<<endl;
            ...
            for(int i=0;i<q[l].len;i++){
                ...
                while(q[l].p[i].bTime!=0 && timer!=10){
                    cout<<"Executing queue 3 and "<<i+1<<" process for a unit time. Process has priority of "<<q[l].p[i].prio<<"\n";
                    q[l].p[i].bTime--;
                    timing(q);
